...
- **Segment:** [e.g., Series B SaaS companies, 100-500 employees, US]
...
| Positive replies | [e.g., 7] | [e.g., 4.9%] |
| Meetings booked | [e.g., 4] | [e.g., 2.8%] |

**Top-performing message:** [Paste the subject line + first 2 lines of the best-performing email]

**What worked:**
- [e.g., Signal-based subject lines had 2x open rate vs. generic]
- [e.g., Shorter emails (under 60 words) got more replies]
...
- [e.g., Focus on Tier 1 only for this segment]
- [e.g., Test problem-led angle instead of signal-based]
- [e.g., Add a 4th follow-up with case study]

---

<!-- Copy the template above for each new campaign. Keep entries in reverse chronological order (newest first). -->
...
| Opened | 62 | 54.4% |
| Replied | 14 | 12.3% |
| Positive replies | 9 | 7.9% |
| Meetings booked | 5 | 4.4% |

**What worked:** Hiring signal in subject line drove opens. Mentioning the specific number of open roles drove replies.
**What didn't work:** LinkedIn connection request added after email didn't increase reply rate.
**Next campaign:** Test referencing the specific job title being hired (e.g., "your new SDR team") vs. generic "scaling outbound."
